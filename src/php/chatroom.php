...
<body>
    ...
    <!-- Add this script tag after the previously added script tag -->
    <!-- <script>
    // Function to update the chat interface with new messages
    function updateChatInterface(messages) {
        // Get the chat container element
        var chatContainer = document.getElementById("chat-messages"); // Replace "chat-container" with your actual chat container element's ID
        ...
        messageElement.innerHTML = message.content; // Assuming the message content is stored in the 'content' field of the message object
        chatContainer.appendChild(messageElement);
        }
    }
    </script> -->

    <!-- Your existing script section in chatroom.php -->

    <!-- <script>
        // Function to send a message using AJAX
        function sendMessage2(user, message) {
            var xhr = new XMLHttpRequest();
        ...
        function handleMessageSend() {
            ...
            var messageContent = document.getElementByClassName("message").innerHTML;
            console.log(messageContent2);
            sendMessage2(sender, messageContent2);
        }
